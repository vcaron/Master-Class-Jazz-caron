                    ...
                    <h1><a href="index.php">Master Class Jazz</span></a></h1>
						<nav>
							<ul class="sf-menu">
								...
								<li><a href="prog semaine.php">Program</a></li>
								<li><a href="index-2.php">Portfolio</a></li>
								<li><a href="Jam.php">Jams</a></li>
                                <li><a href="contact.php">Contacts</a></li>
								<li><a href="logout.php"><span>Offline</span></a></li>
								<?php else: ?>
                                                    ...
                                                    <div id="div-forms">
                                                         <form class="form-signin" action="login.php" method="post">
                                                            ...
                                                            <div class="modal-footer">
                                                                <div>
                                                                    <button type="submit" class=" btn btn-warning btn-lg btn-block">Summit</button>
                                                                </div>
                                                                <div>
                                                                   <a href="inscription.php"> <button type="button" class="btn class=btn btn-warning btn-lg btn-block">Register</button></a>
                                                                </div>
                                                            </div>
                                                        </form>
                                                    </div>
